...
export const Route = createFileRoute("/designers")({
  head: () => ({
    meta: [
      { title: "For Interior Designers & Architects — Receive Qualified Project Leads | AlphaFirms" },
      { name: "description", content: "Stop cold pitching. AlphaFirms routes qualified interior design projects directly to your dashboard — matched to your specialty, budget range, and geography." },
      { name: "robots", content: "index, follow" },
      { property: "og:title", content: "For Interior Designers — Receive Qualified Project Leads | AlphaFirms" },
      { property: "og:description", content: "Stop pitching. Start receiving. Pre-qualified project briefs matched to your specialty and capacity." },
      { property: "og:type", content: "website" },
      { property: "og:url", content: "https://www.alphafirms.com/designers" },
      { property: "og:locale", content: "en_IN" },
      { property: "og:site_name", content: "AlphaFirms" },
      { name: "twitter:card", content: "summary_large_image" },
      { name: "twitter:site", content: "@alphafirms" },
      { name: "twitter:title", content: "Interior Designers — Receive Qualified Leads | AlphaFirms" },
      { name: "twitter:description", content: "Stop pitching. Start receiving. Pre-qualified project briefs matched to your specialty and capacity." },
    ],
    links: [{ rel: "canonical", href: "https://www.alphafirms.com/designers" }],
  }),
...
const designersSchema = JSON.stringify({
  "@context": "https://schema.org",
  "@type": "Service",
  "@id": "https://www.alphafirms.com/designers#service",
  "name": "Project Lead Platform for Interior Designers and Architects",
  "description": "AlphaFirms routes pre-qualified interior design project briefs directly to verified designers and architects matched by specialty, budget range, and geography.",
  "provider": { "@id": "https://www.alphafirms.com/#organization" },
  "areaServed": { "@type": "Country", "name": "India" },
  "serviceType": "Interior Design Lead Generation",
  "audience": { "@type": "Audience", "audienceType": "Interior Designers, Architects, Contractors" },
  "url": "https://www.alphafirms.com/designers",
});

function DesignersPage() {
  return (
    <>
      <script type="application/ld+json" dangerouslySetInnerHTML={{ __html: designersSchema }} />
      ...
      <section className="relative overflow-hidden min-h-screen pt-16 pb-28 md:pt-20 md:pb-36">
        ...
        <div className="relative mx-auto max-w-[1120px] px-6 flex flex-col md:flex-row items-center gap-12 md:gap-16">
          ...
          <m.div variants={stagger} initial="hidden" animate="show" className="flex-1 min-w-0">
            <m.p variants={fadeUp} className="eyebrow" style={{ letterSpacing: "0.14em" }}>For Designers & Contractors</m.p>
            ...
            <m.p variants={fadeUp} className="mt-8 text-[18px] text-muted-foreground" style={{ maxWidth: 500, lineHeight: 1.65 }}>
          ...
          <m.div initial={{ opacity: 0, x: 40, rotate: 2 }} animate={{ opacity: 1, x: 0, rotate: 2 }}
            ...
            <div style={{ width: "100%", height: "100%", borderRadius: 28, overflow: "hidden",
              ...
              <img src={interiorImg} alt="Interior design" loading="lazy" decoding="async" style={{ width: "100%", height: "100%", objectFit: "cover", display: "block" }} />
            </div>
          </m.div>
        </div>
      </section>
      ...
      <section className="py-28 border-t border-border" style={{ background: "linear-gradient(180deg, var(--surface) 0%, var(--background) 100%)" }}>
        <div className="mx-auto max-w-[1120px] px-6 grid gap-16 md:grid-cols-2 md:gap-20 items-start">
          <m.h2 initial="hidden" whileInView="show" viewport={viewportOnce} variants={fadeUp}
          ...
          <m.div initial="hidden" whileInView="show" viewport={viewportOnce} variants={stagger} className="space-y-4">
            {contrast.map((c) => (
              <m.div key={c.before} variants={fadeUp}
